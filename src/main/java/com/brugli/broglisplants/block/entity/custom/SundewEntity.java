...
public class SundewEntity extends BlockEntity implements GeoBlockEntity {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public SundewEntity(BlockPos pPos, BlockState pBlockState) {
        super(BroglisPlantsBlockEntities.SUNDEW_ENTITY.get(), pPos, pBlockState);
